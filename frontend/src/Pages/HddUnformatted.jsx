...
const HddUnformatted = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/hddunformatted_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.220:2001/hddUnformatted`)
          ...
          .then(data => setHddCount(data.unformatted_hdd_count))
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://192.168.100.220:2001/ExportHddUnformattedSites`);
      ...
      const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'HDD Unformatted Sites Data');
        XLSX.writeFile(wb, 'HDD_Unformatted_Sites.xlsx');
    };
    ...
    return (
        <div className="container-fluid">
            <div className='header-sec'>
                <span className='first'>Hdd Unformatted Sites</span>
                <span className='second'>Total Unformatted Sites : <span style={{color:"red"}}> {hddCount} </span></span>
