...
const DVROfflineSites = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.24:2001/dvrofflinesites_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.24:2001/DVROfflineSites`)
      ...
      useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://192.168.100.24:2001/ExportDVROfflineSites`);
...
export default DVROfflineSites;
