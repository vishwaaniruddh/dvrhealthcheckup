...
const HddNotWorkingSites = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/hddnotqorking_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.220:2001/hddnotworking_count`)
          .then(response => response.json())
          .then(data => setHddCount(data.non_ok_hdd_count))
      ...
      const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'HDD Not Working Sites Data');
        XLSX.writeFile(wb, 'HDD_NotWorking_Sites.xlsx');
    };
    ...
    return (
        <div className="container-fluid">
            <div className='header-sec'>
                <span className='first'>Hdd Not Working Sites</span>
                <span className='second'>Total Hdd Down : <span style={{color:"red"}}> {hddCount} </span></span>
...
export default HddNotWorkingSites;
