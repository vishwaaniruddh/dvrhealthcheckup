...
const HddNoDisk = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/hddnodisk_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.220:2001/hddnoDisk`)
          ...
          .then(data => setHddCount(data.no_disk_hdd_count))
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://192.168.100.220:2001/ExportHddNoDiskSites`);
      ...
      const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'HDD No Disk Sites Data');
        XLSX.writeFile(wb, 'HDD_No_Disk_Sites.xlsx');
    };
