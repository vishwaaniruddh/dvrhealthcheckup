...
const OfflineSites = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/netofflinesites_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.220:2001/NetOfflineSites`)
          ...
          .then(data => setOfflineSites(data.net_offline_count))
      ...
      useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://192.168.100.220:2001/ExportNetOfflineSites`);
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, 'Net_Offline_Sites.xlsx');
    };
