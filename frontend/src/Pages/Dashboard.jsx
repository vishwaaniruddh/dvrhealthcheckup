          ...
          <div className='container-fluid center '>
            ...
            <table className="table table-bordered  table2 mt-2">
              ...
              <tr>
                ...
                <td></td>
                <td></td>
                <td colSpan="3">HDD / Lobby Camera Status</td>
              ...
              <tr>
                ...
                <td style={{ fontWeight: "700" }}>
                  ...
                  <table border="1" cellPadding="3" cellSpacing={0} width="100%">
                    ...
                    <tr>
                      <td>Not Login</td>
                      <td>
                        <Link to="/OfflineSites" style={{ textDecoration: "none", color: "red" }}>
                          {dvrofflineSites}
                        </Link>
                      </td>
                    </tr>
                ...
                <td style={{ fontWeight: "700" }}>
                  ...
                  <table border="1" cellPadding="3" cellSpacing={0} width="100%">
                    <tr>
                      <td>HDD Not Working</td>
                      <td>
                        <Link to="/HddNotWorkingSites" style={{ textDecoration: "none", color: "red" }}>
                          {hddNotWorking}
                        </Link>
                      </td>
                    </tr>
                    <tr>
                      <td>Lobby Camera Not Working</td>
                      <td>
                        this - count
                      </td>
                    </tr>
