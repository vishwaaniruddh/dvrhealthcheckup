...
const HddOne = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/hddone_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.220:2001/hddOne`)
          ...
          .then(data => setHddCount(data.one_hdd_count))
    ...
    useEffect(() => {
      ...
      const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'HDD Error One Sites Data');
        XLSX.writeFile(wb, 'HDD_Error_One_Sites.xlsx');
    };
