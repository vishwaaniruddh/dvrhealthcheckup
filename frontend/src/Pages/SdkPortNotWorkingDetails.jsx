...
const SdkPortNotWorkingDetails = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/sdk_not_workingdetails_api", {
...
export default SdkPortNotWorkingDetails;
