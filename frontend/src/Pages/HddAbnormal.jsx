...
const HddAbnormal = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://192.168.100.220:2001/hddabnormal_api", {
    ...
    useEffect(() => {
        ...
        fetch(`http://192.168.100.220:2001/hddAbnormal`)
          ...
          .then(data => setHddCount(data.abnormal_hdd_count))
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://192.168.100.220:2001/ExportHddAbnormalSites`);
      ...
      const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'HDD Abnormal Sites Data');
        XLSX.writeFile(wb, 'HDD_Abnormal_Sites.xlsx');
    };
    ...
    return (
        <div className="container-fluid">
            <div className='header-sec'>
                <span className='first'>Hdd Abnormal Sites</span>
                <span className='second'>Total Hdd Abnormal Sites : <span style={{color:"red"}}> {hddCount} </span></span>
