...
const corsOptions = {
  credentials: true,
  // origin: ['http://103.141.218.138:5173', 'http://192.168.100.23:5173'],// Whitelist the domains you want to allow
...
dvrsite ds ON d.IPAddress = ds.DVRIP
  ...
  query += ` ORDER BY d.last_communication DESC LIMIT ? OFFSET ?`;
